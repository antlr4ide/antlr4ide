 ...
 *******************************************************************************/
package com.github.jknack.ui.railroad.actions;
...
import com.github.jknack.ui.railroad.RailroadSelectionProvider;
import com.github.jknack.ui.railroad.RailroadView;
import com.github.jknack.ui.railroad.RailroadViewPreferences;
...
public class RailroadSelectionLinker implements IPropertyChangeListener {
  ...
  public void diagramSelectionChanged(final SelectionChangedEvent event) {
  ...
  public void textSelectionChanged(final SelectionChangedEvent event) {
    ISelection selection = event.getSelection();
  ...
  protected ISelectable findFigureForTextOffset(final IFigure figure, final int offset, ISelectable currentBestFigure) {
    if(figure == null) {
      return null;
    }
