...
import com.github.jknack.ui.railroad.figures.primitives.CrossPointSegment;
...
public class BypassSegment extends AbstractSegmentFigure {
  ...
  public BypassSegment(final EObject eObject, final ISegmentFigure child, final PrimitiveFigureFactory primitiveFactory) {
    super(eObject);
