...
class Antlr4Formatter extends AbstractDeclarativeFormatter {
  ...
  protected def lexerRule(FormattingConfig c) {
    ...
    c.setIndentation(g.lexerRuleAccess.COLONTerminalRuleCall_2, g.lexerRuleAccess.semicolonSymbolSemicolonKeyword_4_0)
  ...
  protected def parseRule(FormattingConfig c) {
    ...
    // Indent rule body -> ':' body ';'
    c.setIndentation(g.parserRuleAccess.COLONTerminalRuleCall_6, g.parserRuleAccess.semicolonSymbolSemicolonKeyword_9_0)
